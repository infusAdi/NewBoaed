            ...
            <Card.Body>
              <div className="card-title-group align-items-start">
                <div className="card-title">
                  <h4 className="title">{t('login.header')}</h4>
                </div>
              ...
              <ChartLabel.Group className="justify-content-between mt-1">
                <ChartLabel className="chart-label-small">1 May</ChartLabel>
                <ChartLabel className="chart-label-small">8 May</ChartLabel>
                <ChartLabel className="chart-label-small">15 May</ChartLabel>
              </ChartLabel.Group>
            </Card.Body>
          </Card>
        </Col>
          ...
          <Card className="h-100">
            <Card.Body>
              ...
              <ChartLabel.Group className="justify-content-between mt-1">
                <ChartLabel className="chart-label-small">1 May</ChartLabel>
                <ChartLabel className="chart-label-small">15 May</ChartLabel>
                <ChartLabel className="chart-label-small">30 May</ChartLabel>
              </ChartLabel.Group>
            </Card.Body>
          </Card>
        </Col>
        ...
        <Col sm="6" xxl="3">
          <Card className="h-100">
            <Card.Body>
              ...
              <ChartLabel.Group className="justify-content-between mt-1">
                <ChartLabel className="chart-label-small">1 May</ChartLabel>
                <ChartLabel className="chart-label-small">7 May</ChartLabel>
              </ChartLabel.Group>
            </Card.Body>
          </Card>
        </Col>
          ...
          <Card className="h-100">
            <Card.Body>
              ...
              <ChartLegend.Group className="justify-content-around pt-4 flex-wrap gap g-2">
                ...
                <ChartLegend symbol="warning">Tablet</ChartLegend>
                <ChartLegend symbol="success">Desktop</ChartLegend>
                  ...
                  <Timeline.List>
                    <Timeline.Item symbol="user" variant="info">
                      <p className="small">
                        ...
                        <strong>Sara Smith</strong> in a new post
                      </p>
                    </Timeline.Item>
                    <Timeline.Item symbol="signout" variant="warning">
                      <p className="small">
                        The post <strong>Post Name</strong> was removed by{" "}
                        <strong>Nick Mark</strong>
                      </p>
                    </Timeline.Item>
                    <Timeline.Item symbol="file-text" variant="success">
                      <p className="small">
                        <strong>Patrick Sullivan</strong> published a new{" "}
                        <strong>post</strong>
                      </p>
                    </Timeline.Item>
                  </Timeline.List>
                ...
                <Timeline.Group title="yesterday">
                  <Timeline.List>
                    <Timeline.Item symbol="shuffle" variant="info">
                      <p className="small">
                        <strong>240+</strong> users have subscribed to
                        Newsletter #1
                      </p>
                    </Timeline.Item>
                    <Timeline.Item symbol="signout" variant="success">
                      <p className="small">
                        The post <strong>Post Name</strong> was suspended by{" "}
                        <strong>Nick Mark</strong>
                      </p>
                    </Timeline.Item>
                  </Timeline.List>
