...
// import { error, fetching, success } from "reduxStore/reducer/fetchReducers";
...
// navigate("/client");
  ...
  async function postClientData() {
    try {
      // Delete unnecessary properties from testingData
      //   delete testingData.Id;
      //   delete testingData.CreatedOn;
      //   delete testingData.CreatedById;
      //   delete testingData.ModifiedById;
      ...
      console.log(data.value[0]);
      // setValues({ ...data.value[0] }); // Uncomment if you're updating state with the response
    } catch (error) {
  ...
  //         const data = response.data;
  //         console.log(data);
  //         // Assuming the response data contains the new client's details
  //         setValues({ ...data });
  //       }
  //     } catch (error) {
  //       console.error(error);
  ...
  //   // Removed the automatic call to handleSubmitPatch on clientId change
  ...
  //                 navigate(`${tId ? `/testingoffice/${tId}` : ""}/client`);
  //               } else {
  //                 if (data.conflict) {
  //                   dispatch(
  //                     error(
                  ...
                  <div className="gap gy-4">
                    ...
                    <div className="gap-col">
                      ...
                      {view ? (
                        ...
                        >
                          {t("commonWords.form.button.submit")}
                        </Button>
                      )}
                    </li> */}
                        <li>{/* <CancelButton /> */}</li>
